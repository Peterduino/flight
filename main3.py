...
if __name__ == '__main__':
    ...
    p4 = Process(target=mainLoop, args=(shared_data,))
    ...
    time.sleep(1003)          # EARTHSHAKING SETTING : time before the rocket unactivates AFTER TAKE OFF, in secounds (e.g. 5min = 300)
    print("MAIN: stop")
